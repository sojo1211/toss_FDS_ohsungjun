...
특히 이상거래 탐지뿐만 아니라 가맹점과 거래 흐름 전반의 규제 준수 여부를 검증하는 일에 깊은 매력을 느꼈으며, 실무 경험을 넘어 향후 **전문 AML(자금세탁방지) 교육 및 자격 이수**를 계획할 정도로 리스크 통제 프로세스의 고도화에 큰 열정을 가지게 되었습니다.

#### 4️⃣ 미래의 도약: "토스뱅크 비대면 여신의 Anti-Fraud 고도화"
이러한 **이론적 리스크 설계(SRHS 논문) ➡️ 실제 FDS 운영 실무(Toss CX) ➡️ 고도화된 통제(AML 이수 계획)**로 이어지는 저의 성장 스토리의 종착지는 **토스뱅크의 Anti-Fraud Manager**입니다.
