...
* **Practical Risk Assessment & 정량적 성과**: 신용불량 가맹점의 EW 등급, 재무 상태, 보증금을 종합 검토하여 소명 기한(최대 5일) 부여 및 사실관계 기반 최종 의사결정 지원. **월 평균 400건+ RMS Alert 재검토를 통해 오탐 Alert 15% 감축 및 선제적 조치로 사고 발생률 0건 방어**.
...
이 과정에서 금융 도메인의 핵심 리스크 통제 시스템에 깊은 흥미를 가지게 되었고, **Toss CX FDS Team / Pay Risk Management Team**에 합류하여 가맹점 심사, RMS Alert 분류, 소명 검수 등 금융 혁신의 최전선에서 리스크 운영 실무를 직접 경험하며 **월 400건+ Alert 재검토 및 오탐 15% 감축, 사고 발생 0건**이라는 정량적 성과를 입증해 냈습니다.
